...
{
    public SpinnerAdapter(@NonNull Context context, List<SpinnerData> materialList)
    {
    ...
    private View initView(int position, View convertView, ViewGroup parent)
    {
        ...
        TextView textViewName = convertView.findViewById(R.id.materials);
        SpinnerData currentItem = getItem(position);

        if (currentItem != null)
        {
            textViewName.setText(currentItem.material);
        }
